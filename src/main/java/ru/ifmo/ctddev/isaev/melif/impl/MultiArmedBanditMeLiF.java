 ...
 * @author iisaev
 */
public class MultiArmedBanditMeLiF extends BasicMeLiF {
    ...
    public MultiArmedBanditMeLiF(AlgorithmConfig config, DataSet dataSet, int threads) {
        this(config, dataSet, Executors.newFixedThreadPool(threads));
    }

    public MultiArmedBanditMeLiF(AlgorithmConfig config, DataSet dataSet, ExecutorService executorService) {
